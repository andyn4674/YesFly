...
exports.FAAProxyService = void 0;
 ...
 */
class FAAProxyService {
    constructor() {
        this.FAA_API_URL = 'https://services6.arcgis.com/ssFJjBXIUyZDrSYZ/ArcGIS/rest/services/FAA_UAS_FacilityMap_Data/FeatureServer/0/query';
     ...
     */
    async getFAARestrictions(lat, lng, radius) {
        try {
            ...
            const response = await axios_1.default.get(this.FAA_API_URL, {
                params: {
                    f: 'json',
                    geometry: envelope,
    ...
    transformFAAResponse(faaData) {
        ...
        const features = faaData.features.map((feature) => {
            ...
            const restrictionType = maxAGL === 0 ? types_1.RestrictionType.NO_FLY : types_1.RestrictionType.AUTH_REQUIRED;
     ...
     */
    convertESRIToGeoJSON(esriGeometry) {
        if (!esriGeometry) {
            return {
                type: 'Point',
                coordinates: [0, 0]
...
exports.FAAProxyService = FAAProxyService;
//# sourceMappingURL=faaProxyService.js.map